...
export default function ShipDetailsInfoButton({ data_info, ships, reload}) {
  ...
  const handleSubmit = async (change) => {
    try {
      await api.post("/port/changeShipDetails", {
        ...infoText,
        isChange: change,
      });
      reload();
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={handleClose} fullWidth maxWidth="sm">
        ...
        <DialogActions>
          ...
          {!isEditing ? (
            ...
            <Button onClick={handleOpenChange} variant="contained">
              Изменить
            </Button>
          )}
        </DialogActions>
      ...
      <Dialog open={change} onClose={handleChangeClose} maxWidth="xs" fullWidth>
        <DialogTitle>Добавить изменение в архив? </DialogTitle>
        <DialogActions>
          <Button onClick={() => handleSubmit(true)} sx={{ color: "red" }}>
            Нет
          </Button>
          <Button onClick={() => handleSubmit(false)}>Да</Button>
        </DialogActions>
      </Dialog>
    </>
  );
