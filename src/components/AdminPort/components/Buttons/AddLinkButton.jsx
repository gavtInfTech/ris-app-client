...
export default function AddLinkButton({ id, reload }) {
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
        <DialogTitle>Добавить статус судна: </DialogTitle>
        <DialogContent
        ...
        <DialogActions>
          ...
          <Button onClick={handleSubmit}>Добавить статус</Button>
        </DialogActions>
      </Dialog>
    </>
  );
