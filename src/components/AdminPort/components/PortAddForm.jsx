...
export default function PortAddForm({ portId, bigReload}) {
      ...
      <Dialog open={open} onClose={handleClose} fullWidth maxWidth="sm">
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            />
            {formData.id_ship && (
              <IconButton onClick={() => handleShipInfoOpen(formData.id_ship)}>
                <InfoIcon />
              </IconButton>
            )}
          </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    {sostavForm.id && (
                      <IconButton
                        onClick={() => handleShipInfoOpen(sostavForm.id)}
                      >
                        <InfoIcon />
                      </IconButton>
                    )}
                ...
                <DialogActions>
                  ...
                  <Button
                    onClick={() => {
                      if (sostavForm.id) {
                        setFormData((prev) => {
                          const updated = [...prev.sostav_ship_ids];
                          if (editIndex !== null) {
                            // Редактирование
                            updated[editIndex] = sostavForm;
                          } else {
                            // Добавление
                            updated.push(sostavForm);
                          }
                          return { ...prev, sostav_ship_ids: updated };
                        });
