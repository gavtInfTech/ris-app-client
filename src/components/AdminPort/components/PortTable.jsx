...
import PortTableSend from "./SendShipForm.jsx";

export default function PortTable({ portId, bigReload, bigForceReload }) {
        ...
        if (row.isSostavRow) {
          return [
            ...
            <RemoveSostavButton
              ...
              reload={reload}
            />,
            <DeleteRecordButton reload={reload} id={row.shipDetails.id} />,
          ];
        }
        return [
          <PreviewShipDetailsButton ships={ships} id={row.shipDetails.id} />,
          <AddLinkButton
            ships={ships}
            portName={portId}
            id={row.shipDetails.id}
          ...
          <AddSostavButton
            ...
            reload={reload}
          />,
          <ShipSendButton reload={reload} ships={ships} data_info={params.row.shipDetails} bigReload={bigReload} />,
          <DeleteRecordButton reload={reload} id={id} />,
        ];
      },
    },
  ];
